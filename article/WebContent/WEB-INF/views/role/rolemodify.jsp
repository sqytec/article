					...
					<section id="content">
						<section class="vbox">
							...
							<section class="scrollable padder">
								...
								<!-- 表格标题 -->
								<div class="m-b-md">
									<h2 class="m-b-none">修改角色信息</h2>
								</div>
								
								<form id="form" action="<%= basePath %>role/modifyRole" method="post" 
	            					...
	            					<section class="panel panel-default">
		                                ...
		                                <div class="panel-body">
	                                        ...
	                                        <div class="form-group">
	                                            ...
	                                            <div class="col-sm-5">
	                                                <input type="text" name="rolename" class="form-control"  data-required="true" 
	                                        ...
	                                        <div class="form-group">
	                                            ...
	                                            <div class="col-sm-5">
	                                                <input type="text" name="roledesc" class="form-control" data-notblank="true" 
	                                                	data-maxlength="300" placeholder="请输入角色描述..." value="${role.roledesc}">
	                                            </div>
	                                        </div>
	                                        ...
	                                        <div class="form-group">
	                                            ...
	                                            <div class="col-sm-5">
	                                                <select name="rolestate" class="form-control m-b">
	                                                    <option value="1" <c:if test="${role.rolestate == 1}">selected="selected"</c:if>>正常</option>
	                                                    <option value="0" <c:if test="${role.rolestate == 0}">selected="selected"</c:if>>禁用</option>
	                                                </select>
