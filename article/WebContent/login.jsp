	...
	<body>
		<section id="content" class="m-t-lg wrapper-md animated fadeInUp">
			<div class="container aside-xxl"> 
					<a class="navbar-brand block" href="#">24KCoder</a>
					<section class="panel panel-default bg-white m-t-lg">
						...
						<form action="<%= basePath %>login" method="post" 
							...
							<div class="form-group">
								...
								<input name="loginname" type="text" placeholder="enter user's name" 
							...
							<div class="form-group">
								...
								<input name="password" type="password" id="inputPassword" data-required="true"
									...
									placeholder="enter pass" class="form-control input-lg">
							</div>
							...
							<div class="form-group">
								...
								<input name="code" type="text" id="code" data-required="true"
									...
									placeholder="enter validate code" class="form-control input-lg"/>
								<br>
